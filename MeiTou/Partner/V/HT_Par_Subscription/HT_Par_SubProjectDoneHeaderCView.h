...
@property (weak, nonatomic) IBOutlet UIImageView *imageVLineE;
@property (weak, nonatomic) IBOutlet UIImageView *imageVLineF;
@property (weak, nonatomic) IBOutlet UIImageView *imageVLineG;
...
@property (weak, nonatomic) IBOutlet UILabel *labelDoneM;
@property (weak, nonatomic) IBOutlet UILabel *labelRest;
@property (weak, nonatomic) IBOutlet UILabel *labelRestM;
@property (weak, nonatomic) IBOutlet UILabel *labelResulet;
